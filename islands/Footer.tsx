...
export default function Footer() {
  ...
  return (
    <footer
      class="fixed bottom-0 left-0 right-0 z-50 border-t border-transparent"
      style={{ backgroundImage: 'linear-gradient(to top, var(--theme-background-opaque) 40%, transparent 100%)' }}
    >
      <div class="max-w-screen-xl mx-auto px-4 py-4">
        <div class={`flex items-center justify-center gap-2 sm:gap-4 transition-opacity duration-300 ${isLoaded.value ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <div class="flex items-center gap-1 sm:gap-2">
            ...
            >
              <svg class="w-3 h-3 mr-1 sm:mr-1.5" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              <svg class="w-3 h-3 mr-1 sm:mr-1.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path d="M3 3v18h18"/>
          ...
          {commitHash.value && (
            <div class="flex items-center gap-1 sm:gap-2">
              ...
              <div class="flex items-center gap-1 sm:gap-2 text-xs">
                ...
                >
                  <svg class="w-3 h-3 mr-0.5 sm:mr-1" fill="currentColor" viewBox="0 0 24 24">
          ...
          {error.value && (
            <div class="flex items-center">
              <div class="w-px h-3 sm:h-4 dark:bg-red-500/20 bg-red-500/20"></div>
