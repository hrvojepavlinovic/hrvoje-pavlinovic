  ...
  return (
    <div class="grid gap-8 md:grid-cols-2">
      {sortedProjects.map(project => {
        return (
          <div key={project.id} class="group p-6 border border-gray-200 dark:border-gray-800 rounded-lg hover:border-gray-300 dark:hover:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900/50 flex flex-col h-full">
