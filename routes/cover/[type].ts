...
const coverLetterTemplates: Record<string, CoverLetterTemplate> = {
  ...
  bitcoin: {
    ...
    closing: "I would welcome the opportunity to discuss how my Bitcoin passion, Lightning/Stacks/Nostr expertise, and commitment to sound money principles align with {companyName}'s mission in the Bitcoin ecosystem.",
    skills: ["Bitcoin Protocol", "Lightning Network", "Stacks Blockchain", ".btc Domains", "Nostr Protocol", "Bitcoin Security"]
  },
  ai: {
    opening: "I am writing to express my strong interest in the {position} position at {companyName}. With 12+ years of software engineering experience and hands-on expertise in AI/LLM integration, vector databases, and intelligent pipeline architecture, I am excited about the opportunity to drive artificial intelligence innovation and implementation at your organization.",
    body: [
      "My AI expertise spans the full spectrum of modern AI implementation, from LLM integration to sophisticated vector database architectures. In Memoato, I built an AI-powered platform integrating GPT Turbo and Whisper APIs with intelligent data categorization and voice processing. I've extensively experimented with vector databases like Qdrant for semantic search and similarity matching, including ingesting PDF data into vector databases for intelligent document processing and retrieval.",
