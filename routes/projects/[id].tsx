...
export default function ProjectPage({ data: project }: PageProps<Project>) {
  if (!project || !project.pitch) {
    return (
      <div class="min-h-screen bg-white text-gray-900 dark:bg-gray-950 dark:text-gray-100 px-6 py-24">
  ...
  const sections: Array<{ title: string; body?: string; list?: string[] }> = [
    ...
    pitch.fundsAllocation && pitch.fundsAllocation.length
      ...
      : undefined,
    pitch.pricingModel ? { title: "Business model", body: pitch.pricingModel } : undefined,
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={pitch.problem ?? project.description} />
      </Head>
          ...
          <div class="max-w-5xl mx-auto px-6 py-12 md:py-16 space-y-8">
            <div class="space-y-3">
              ...
              <p class="max-w-3xl text-sm text-gray-600 dark:text-gray-400">
                Snapshot of the problem, solution, and capital plan. Full financials available on request.
              </p>
            </div>
            ...
            <div class="space-y-6">
              {sections.map((section) => (
                <div
                  key={section.title}
                  class="space-y-3 rounded-2xl border border-gray-200 bg-white/80 p-6 dark:border-gray-800 dark:bg-gray-900/40"
                >
            ...
            {(pitch.teamCosts || pitch.pricingModel) && (
              <div class="space-y-6 rounded-2xl border border-gray-200 bg-white/80 p-6 dark:border-gray-800 dark:bg-gray-900/40">
                {pitch.teamCosts && (
                  <div class="space-y-2">
                    <h3 class="text-sm font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
                      Team & burn
