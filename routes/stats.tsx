  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Analytics and statistics for hrvoje.pavlinovic.com - Explore visitor metrics, page views, and performance data."
        />
        <meta
          name="keywords"
          content="Website Analytics, Site Statistics, Page Views, Performance Metrics, Hrvoje Pavlinovic"
        />
        ...
        <meta
          name="twitter:title"
          content="Website Stats | Hrvoje Pavlinovic"
        />
        <meta
